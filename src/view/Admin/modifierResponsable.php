<?php
include __DIR__ . "../../../controller/modifierResponsableController.php";
?>
...
<head>
    ...
    <title>Modifier | Responsables</title>
</head>
...
<body class="bg-blue-100">
    <div class="flex items-center gap-[20%] mt-5">
        ...
        <h1 class="text-2xl font-serif border-b rounded-2xl shadow-black p-1.5">Modification des informations du Responsable</h1>
    </div>

    <div class="relative">

        <div class="absolute top-3 left-120">
            <a href="Responsables.php" class="inline-block">
        ...
        <form class="flex flex-col items-center rounded-xl bg-white m-auto border h-auto w-150 gap-5 p-1.5 border-blue-100 shadow-2xl shadow-blue-400"
            action="../../controller/modifierResponsableController.php"
            method="POST">
            ...
            <div class="flex flex-col gap-2">
                ...
                <input class="border rounded-lg w-55 p-1" id="login" type="text" name="login" value="<?= $login ?>">
            </div>

            <div class="flex flex-col gap-2">
                <label for="login">mot de passe: </label>
                <input class="border rounded-lg w-55 p-1" id="login" type="text" name="password" value="<?= $password ?>">
            </div>
    ...
    <script>
        function deleteConfirm(event) {
            if (event.target.closest(".save")) {
                const ok = confirm("Êtes-vous sûr de vouloir enregistrer les modifications pour cet responsable ?");
