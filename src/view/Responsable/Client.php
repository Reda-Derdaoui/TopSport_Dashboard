                    ...
                    <tbody class="divide-y divide-slate-100 text-sm text-slate-600">
                        <?php foreach ($adherents as $adherent): ?>
                            <tr class="bg-slate-50 hover:bg-slate-200 transition-colors duration-200">
                                ...
                                <td class="p-2 font-semibold text-slate-700"><?= (new DateTime($adherent["DateNaissance"]))->format('d-m-Y') ?></td>
                                ...
                                <td class="p-2 font-semibold text-slate-700"><?= (new DateTime($adherent["DateDebut"]))->format('d-m-Y')  ?></td>
                                <td class="p-2 font-semibold text-slate-700"><?= (new DateTime($adherent["DateFin"]))->format('d-m-Y') ?></td>
                                ...
                                <td class="p-2">
                                    <div class="flex items-center justify-center ">
                                        ...
                                        <a href="./modifierAdherent.php?Id_adherent=<?= $adherent["Id_adherent"] ?>&Id_Abonnement=<?= $adherent["Id_Abonnement"] ?>">
                                            <button
                                        ...
                                        <a href="../../controller/suprimerAdherent.php?Id_adherent=<?= $adherent["Id_adherent"] ?>">
                                        ...
                                        <a href="../../../lib/FPDF/controller/imprimerAdherentController.php?Id_adherent=<?= $adherent["Id_adherent"]  ?>" target="_blank">
